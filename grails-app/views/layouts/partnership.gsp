...
<head>
    ...
    <meta id="description" content='The page contains the information about the ways of contribution to the development of the current project. Also here you can find the list of people interested in PlantChemDB.' name='description'/>
    <meta id="keywords" content='scientific publication, essential oil study, author, citation index, PlantChemDB, support' name='keywords'/>
    <link rel="shortcut icon" href="/favicon.png" type="image/x-icon">
    <title>Partnership: PlantChemDB</title>
